...
class _TCInstructionsScreenState extends State<TCInstructionsScreen> with InstructionSnapshotHelper<TCInstructionsScreen> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (!showSpecific) ...[
                      ...
                      ...List.generate(tcSpecificInstructions.length, (i) =>
                          Padding(
                            padding: const EdgeInsets.symmetric(
                                vertical: 2.0),
                            child: CheckboxListTile(
