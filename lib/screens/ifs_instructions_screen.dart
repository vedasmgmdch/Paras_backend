...
class _IFSInstructionsScreenState extends State<IFSInstructionsScreen>
    with InstructionSnapshotHelper<IFSInstructionsScreen> {
  ...
  static const List<Map<String, String>> doList = [
    ...
    {"en": "Use warm salt water rinse as instructed.", "mr": "सूचना दिल्याप्रमाणे कोमट मीठाच्या पाण्याने गुळण्या करा."},
    {"en": "Eat your medicine as prescribed by your dentist.", "mr": "तुमच्या दंतवैद्यांनी सांगितलेली औषधे घ्या."},
    {
  ...
  static const List<Map<String, String>> specificInstructions = [
    {
      ...
      "mr":
          "पहिल्या २४ तासांसाठी त्या भागावर टॉवेलमध्ये गुंडाळलेली बर्फाची पिशवी १५–२० मिनिटांच्या अंतराने लावा. १५ मिनिटे लावा, ५ मिनिटे काढा.",
    },
    {
      "en": "Do not rinse or spit for 24 hours after surgery.",
      "mr": "शस्त्रक्रियेनंतर २४ तास गुळण्या किंवा थुंकू नका.",
    },
    {
      ...
      "mr":
          "पहिल्या दिवसानंतर, जेवणानंतर आठवडाभर कोमट मीठाच्या पाण्याने गुळण्या करा, जेणेकरून शस्त्रक्रिया क्षेत्रात अडकलेल्या अन्नकण व घाण निघून जाईल.\n(अर्धा चमचा मीठ कोमट पाण्यात मिसळा.)",
    },
    {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      final hydratedGeneral = appState.buildFollowedChecklistForDay(
        day: selectedDate,
        type: 'general',
        length: doList.length,
        instructionTextForIndex: (i) => doList[i][selectedLang] ?? '',
        username: appState.username,
        treatment: appState.treatment,
        subtype: appState.treatmentSubtype,
      );
