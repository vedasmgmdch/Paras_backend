...
class _TWInstructionsScreenState extends State<TWInstructionsScreen> with InstructionSnapshotHelper<TWInstructionsScreen> {
  ...
  // Defer snapshot to post-frame for consistency
...
""".trim();
  ...
  Widget build(BuildContext context) {
    ...
    if (treatment != null && treatment.isNotEmpty) {
      ...
      title = selectedLang == 'en'
          ? "Instructions (Tooth Whitening)"
          : "सूचना (दात पांढरे करणे)";
    }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (!showSpecific) ...[
                      ...
                      ...List.generate(twSpecificInstructions.length, (i) =>
                          Padding(
                            padding: const EdgeInsets.symmetric(
                                vertical: 2.0),
                            child: CheckboxListTile(
