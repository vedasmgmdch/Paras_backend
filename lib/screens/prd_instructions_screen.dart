...
class _PRDInstructionsScreenState extends State<PRDInstructionsScreen>
    with InstructionSnapshotHelper<PRDInstructionsScreen> {
  ...
  static const List<Map<String, String>> prdDos = [
    ...
    {"en": "Clean your dentures daily using a soft denture brush.", "mr": "मऊ डेन्चर ब्रशने दररोज डेन्चर स्वच्छ करा."},
    {"en": "Soak dentures in a denture cleanser overnight.", "mr": "रात्री डेन्चर क्लिन्झरमध्ये डेन्चर भिजत ठेवा."},
    {
  ...
  static const List<Map<String, String>> prdDonts = [
    {"en": "Do not use hot water to clean dentures.", "mr": "डेन्चर स्वच्छ करण्यासाठी गरम पाणी वापरू नका."},
    {"en": "Avoid dropping dentures on hard surfaces.", "mr": "डेन्चर कठीण पृष्ठभागावर पडू देऊ नका."},
    {
  ...
  static const List<Map<String, String>> specificInstructions = [
    ...
    {"en": "Keep dentures in water when not wearing them.", "mr": "डेन्चर वापरत नसताना नेहमी पाण्यात ठेवा."},
  ];
                      ...
                      ...List.generate(
                        ...
                        (i) => Padding(
                          ...
                          child: CheckboxListTile(
                            ...
                            dense: true,
                            title: Text(prdDos[i][selectedLang]!, style: const TextStyle(fontSize: 15)),
                            value: _dosChecked[i],
